...
*/
#define DEADZONE 5  // RJS: 0    HJS:3  Recommended to have this as small as possible to allow full range of motion.
...
//              {  AX,   AY,   BX,   BY,   CX,   CY,   DX,   DY}
#define MINVALS {-488, -508, -536, -460, -502, -503, -556, -312}
#define MAXVALS {463, 417, 415, 491, 449, 426, 395, 468}
...
#define SENS_PTZ 15.00  // RJS:15.0  HJS:8.00
#define SENS_NTZ  7.00  // RJS:7.00  HJS:6.00  I want low sensitivity for down, therefore a high value.
...
#define MODFUNC       3     // RJS:3     HJS:3     used as default value as long as the data hasn't been saved in the EEPROM
#define MOD_A 1.15  // RJS:1.15  HJS:1.10  exponent "a", recommended: 1.0 ... 3.0  [anything from linear to x^3]  -> bigger value flattens the curve more near zero (on MODFUNC 1 and 3)
#define MOD_B  1.15  // RJS:1.15  HJS:1.15  factor "b",   recommended: 1.0 ... 1.57 [tan(0..1) up to tan(0..pi/2)] -> bigger value increases the curve more away from zero (on MODFUNC 3)
...
#define INVX  0  // pan left/right                           RJS:1     HJS:0
...
#define COMP_EN    1        // enable the compensation    RJS:0     HJS:1
...
*/
#define EXCLUSIVE   1             // RJS:1     HJS:0
#define EXCL_HYST   5
...
*/
#define EXCL_PRIOZ 1      // RJS:1     HJS:0
...
#define BUTTONLIST { SM_T, SM_F, SM_R, SM_RCW, SM_MENU }
